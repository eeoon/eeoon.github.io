...
<title>escape-string-regexp | Youngman</title>
...
<meta property="twitter:title" content="escape-string-regexp" />
<script type="application/ld+json">
{"@context":"https://schema.org","@type":"WebPage","author":{"@type":"Person","name":"Youngeon"},"dateModified":"2024-11-16T11:51:59+09:00","description":"Hydejack is a boutique Jekyll theme for hackers, nerds, and academics, with a focus on personal sites that are meant to impress.","headline":"escape-string-regexp","publisher":{"@type":"Organization","logo":{"@type":"ImageObject","url":"http://localhost:4000/assets/img/avatar.JPG"},"name":"Youngeon"},"url":"http://localhost:4000/node_modules/escape-string-regexp/"}</script>
<!-- End Jekyll SEO tag -->
...
<link rel="alternate" href="http://localhost:4000/node_modules/escape-string-regexp/" hreflang="en">
...
>
  <nav id="breadcrumbs" class="screen-only"><ul>
    ...
    <li><a href="/">home</a></li>
      ...
      <li>
          ...
          <span>/</span>
          <span>escape-string-regexp</span>
  ...
  <header>
    <h1 class="page-title">escape-string-regexp</h1>
...
<div class="language-plaintext highlighter-rouge"><div class="highlight"><pre class="highlight"><code>$ npm install --save escape-string-regexp
</code></pre></div></div>

<h2 id="usage">Usage</h2>

<div class="language-js highlighter-rouge"><div class="highlight"><pre class="highlight"><code><span class="kd">const</span> <span class="nx">escapeStringRegexp</span> <span class="o">=</span> <span class="nx">require</span><span class="p">(</span><span class="dl">'</span><span class="s1">escape-string-regexp</span><span class="dl">'</span><span class="p">);</span>

<span class="kd">const</span> <span class="nx">escapedString</span> <span class="o">=</span> <span class="nx">escapeStringRegexp</span><span class="p">(</span><span class="dl">'</span><span class="s1">how much $ for a unicorn?</span><span class="dl">'</span><span class="p">);</span>
