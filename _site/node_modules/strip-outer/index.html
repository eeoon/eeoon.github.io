...
<title>strip-outer | Youngman</title>
<meta name="generator" content="Jekyll v3.9.3" />
<meta property="og:title" content="strip-outer" />
...
<link rel="canonical" href="http://localhost:4000/node_modules/strip-outer/" />
<meta property="og:url" content="http://localhost:4000/node_modules/strip-outer/" />
<meta property="og:site_name" content="Youngman" />
<meta property="og:type" content="website" />
<meta name="twitter:card" content="summary" />
<meta property="twitter:title" content="strip-outer" />
<script type="application/ld+json">
{"@context":"https://schema.org","@type":"WebPage","author":{"@type":"Person","name":"Youngeon"},"dateModified":"2024-11-16T11:51:59+09:00","description":"Hydejack is a boutique Jekyll theme for hackers, nerds, and academics, with a focus on personal sites that are meant to impress.","headline":"strip-outer","publisher":{"@type":"Organization","logo":{"@type":"ImageObject","url":"http://localhost:4000/assets/img/avatar.JPG"},"name":"Youngeon"},"url":"http://localhost:4000/node_modules/strip-outer/"}</script>
<!-- End Jekyll SEO tag -->
...
<link rel="alternate" href="http://localhost:4000/node_modules/strip-outer/" hreflang="en">
...
>
  ...
  <header>
    <h1 class="page-title">strip-outer</h1>
...
<div class="language-plaintext highlighter-rouge"><div class="highlight"><pre class="highlight"><code>$ npm install --save strip-outer
</code></pre></div></div>

<h2 id="usage">Usage</h2>

<div class="language-js highlighter-rouge"><div class="highlight"><pre class="highlight"><code><span class="kd">const</span> <span class="nx">stripOuter</span> <span class="o">=</span> <span class="nx">require</span><span class="p">(</span><span class="dl">'</span><span class="s1">strip-outer</span><span class="dl">'</span><span class="p">);</span>

<span class="nx">stripOuter</span><span class="p">(</span><span class="dl">'</span><span class="s1">foobarfoo</span><span class="dl">'</span><span class="p">,</span> <span class="dl">'</span><span class="s1">foo</span><span class="dl">'</span><span class="p">);</span>
<span class="c1">//=&gt; 'bar'</span>

<span class="nx">stripOuter</span><span class="p">(</span><span class="dl">'</span><span class="s1">unicorncake</span><span class="dl">'</span><span class="p">,</span> <span class="dl">'</span><span class="s1">unicorn</span><span class="dl">'</span><span class="p">);</span>
