...
<title>trim-repeated | Youngman</title>
<meta name="generator" content="Jekyll v3.9.3" />
<meta property="og:title" content="trim-repeated" />
...
<link rel="canonical" href="http://localhost:4000/node_modules/trim-repeated/" />
<meta property="og:url" content="http://localhost:4000/node_modules/trim-repeated/" />
<meta property="og:site_name" content="Youngman" />
<meta property="og:type" content="website" />
<meta name="twitter:card" content="summary" />
<meta property="twitter:title" content="trim-repeated" />
<script type="application/ld+json">
{"@context":"https://schema.org","@type":"WebPage","author":{"@type":"Person","name":"Youngeon"},"dateModified":"2024-11-16T11:51:59+09:00","description":"Hydejack is a boutique Jekyll theme for hackers, nerds, and academics, with a focus on personal sites that are meant to impress.","headline":"trim-repeated","publisher":{"@type":"Organization","logo":{"@type":"ImageObject","url":"http://localhost:4000/assets/img/avatar.JPG"},"name":"Youngeon"},"url":"http://localhost:4000/node_modules/trim-repeated/"}</script>
<!-- End Jekyll SEO tag -->
...
<link rel="alternate" href="http://localhost:4000/node_modules/trim-repeated/" hreflang="en">
...
>
  ...
  <header>
    <h1 class="page-title">trim-repeated</h1>
  ...
  <blockquote>
  <p>Trim a consecutively repeated substring: <code class="language-plaintext highlighter-rouge">foo--bar---baz</code> → <code class="language-plaintext highlighter-rouge">foo-bar-baz</code></p>
</blockquote>

<h2 id="install">Install</h2>

<div class="language-plaintext highlighter-rouge"><div class="highlight"><pre class="highlight"><code>$ npm install --save trim-repeated
</code></pre></div></div>

<h2 id="usage">Usage</h2>

<div class="language-js highlighter-rouge"><div class="highlight"><pre class="highlight"><code><span class="kd">var</span> <span class="nx">trimRepeated</span> <span class="o">=</span> <span class="nx">require</span><span class="p">(</span><span class="dl">'</span><span class="s1">trim-repeated</span><span class="dl">'</span><span class="p">);</span>

<span class="nx">trimRepeated</span><span class="p">(</span><span class="dl">'</span><span class="s1">foo--bar---baz</span><span class="dl">'</span><span class="p">,</span> <span class="dl">'</span><span class="s1">-</span><span class="dl">'</span><span class="p">);</span>
<span class="c1">//=&gt; 'foo-bar-baz'</span>

<span class="nx">trimRepeated</span><span class="p">(</span><span class="dl">'</span><span class="s1">foo@#@#baz</span><span class="dl">'</span><span class="p">,</span> <span class="dl">'</span><span class="s1">@#</span><span class="dl">'</span><span class="p">);</span>
...
<ul>
  <li><a href="https://github.com/sindresorhus/condense-whitespace"><code class="language-plaintext highlighter-rouge">condense-whitespace</code></a> - Remove leading, trailing and repeated whitespace from a string</li>
</ul>
