...
<link rel="canonical" href="http://localhost:4000/node_modules/slash/" />
<meta property="og:url" content="http://localhost:4000/node_modules/slash/" />
<meta property="og:site_name" content="Youngman" />
<meta property="og:type" content="website" />
<meta name="twitter:card" content="summary" />
<meta property="twitter:title" content="slash" />
<script type="application/ld+json">
{"@context":"https://schema.org","@type":"WebPage","author":{"@type":"Person","name":"Youngeon"},"dateModified":"2024-11-16T11:51:59+09:00","description":"Hydejack is a boutique Jekyll theme for hackers, nerds, and academics, with a focus on personal sites that are meant to impress.","headline":"slash","publisher":{"@type":"Organization","logo":{"@type":"ImageObject","url":"http://localhost:4000/assets/img/avatar.JPG"},"name":"Youngeon"},"url":"http://localhost:4000/node_modules/slash/"}</script>
<!-- End Jekyll SEO tag -->
...
<link rel="alternate" href="http://localhost:4000/node_modules/slash/" hreflang="en">
...
>
  ...
  <blockquote>
  <p>Convert Windows backslash paths to slash paths: <code class="language-plaintext highlighter-rouge">foo\\bar</code> ➔ <code class="language-plaintext highlighter-rouge">foo/bar</code></p>
</blockquote>
...
<p>This was created since the <code class="language-plaintext highlighter-rouge">path</code> methods in Node.js outputs <code class="language-plaintext highlighter-rouge">\\</code> paths on Windows.</p>

<h2 id="install">Install</h2>

<div class="language-plaintext highlighter-rouge"><div class="highlight"><pre class="highlight"><code>$ npm install slash
</code></pre></div></div>
...
<span class="kd">const</span> <span class="nx">slash</span> <span class="o">=</span> <span class="nx">require</span><span class="p">(</span><span class="dl">'</span><span class="s1">slash</span><span class="dl">'</span><span class="p">);</span>

<span class="kd">const</span> <span class="nx">string</span> <span class="o">=</span> <span class="nx">path</span><span class="p">.</span><span class="nx">join</span><span class="p">(</span><span class="dl">'</span><span class="s1">foo</span><span class="dl">'</span><span class="p">,</span> <span class="dl">'</span><span class="s1">bar</span><span class="dl">'</span><span class="p">);</span>
