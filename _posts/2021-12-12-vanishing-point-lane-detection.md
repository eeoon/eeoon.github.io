---
layout: post
title: "영상처리 기반 자율주행: Vanishing Point와 Perspective Transform"
date: 2021-12-12 09:00:00 +0900
description: "소실점(Vanishing Point)과 원근 변환을 결합해 주행 상태(직진/회전 × 중앙/치우침)를 판단하는 영상처리 프로젝트"
...
vanishing paper.pd.pdf (원문 PDF는 미첨부)

TIP2012.pdf (원문 PDF는 미첨부)

Vanishing_Point_Detection_WACV2017.pdf (원문 PDF는 미첨부)
